...
public class GameTicTacToeMovementServiceTest extends IntegratedBaseTest {
  ...
  //
  //    GameMovementException exception = Assertions.assertThrows(
  //      GameMovementException.class,
  //      () -> gameMovementService.execute(
  //        id,
  //        null
  //      )
  //    );
  ...
  //
  //    GameMovementResponseDto responseDto = gameMovementService.execute(
  //      id,
  //      null
  //    );
  //
  ...
  //
  //    when(gameRepository.findById(id)).thenReturn(Optional.of(gameReturn));
  //    when(movementRepository.findMovementByGameAndXAndY(
  //      gameReturn,
  //      0,
  //      1
  //    )).thenReturn(Optional.of(movementReturn));
  //
  //    GameMovementException exception = Assertions.assertThrows(
  //      GameMovementException.class,
  //      () -> gameMovementService.execute(
  ...
  //      "Movimento inválido, x=%d, y=%d, player=%s",
  //      0,
  //      1,
  //      "O"
  //    );
